...
\begin{document}
 ...
 \end{minipage}
	...
	Pour montrer la cohérence de notre système nous testons également la propriété de vivacité du système précédent :
	\begin{center}
		SPEC AF (ped\_l.state = green);
	\end{center}
	\begin{center}
	...
	\newline	Nous allons tester les propriétés énoncées dans les points précédents. Nous allons changer le système de tel sorte à ce que le feu de piéton ne passe plus au vert même après un appel. Nos propriétés seront fausses dans ce système.
	\begin{center}
  ...
  \chapter*{Conclusion}
  	Nous avons donc réussi à exposer des cas particuliers pour que nos propriétés soient fausses, et donc montrer que si ces dernières sont vraies dans nos systèmes c'est que ces situations ne se produisent jamais. De plus nos systèmes ont des modules indépendants ce qui nous permet par exemple de simuler des carrefours facilement.
